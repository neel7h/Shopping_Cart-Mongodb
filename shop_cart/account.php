...
<?php } elseif (!isset($_GET["order"])) { ?>
    ...
    try {
        require_once 'db.php';
		$collection = $db->user;
        $sweetQuery = $collection->findOne(array('_id' =>($_SESSION["account"])));
    ...
    <div class="container">
        ...
        <table class="table table-hover">
            ...
            try {
                ...
                $something = $collection->findOne(array('user_id' => ($_SESSION["account"])));
    ...
    <div class="container">
        ...
        <ul id="basket_list" class="list-group">
            ...
            try {
                ...
                require_once 'db.php';
                $sweetQuery = $collection->findOne(array('_id' => new MongoDB\BSON\ObjectID($_GET["order"])));
